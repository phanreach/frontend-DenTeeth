...
export default function Appointments() {
 ...
 const setStatus = (id: string, status: "confirmed" | "rejected" | "completed") => {
 ...
 className="h-11 w-full rounded-2xl border border-indigo-600/10 bg-card pl-10 pr-3 text-sm text-foreground outline-none transition focus:border-indigo-600/40 focus:ring-4 focus:ring-indigo-50 "
 />
 </div>
 <div className="flex items-center gap-2">
 <button
 onClick={() => setSortMode((prev) => (prev === "date" ? "name" : "date"))}
 className="inline-flex h-11 cursor-pointer items-center gap-2 rounded-2xl bg-indigo-600/10 px-4 text-xs font-semibold text-indigo-600 transition hover:bg-indigo-600/20 active:scale-95 "
 >
 ...
 className={`flex h-9 cursor-pointer items-center gap-2 rounded-full px-4 text-xs font-semibold transition active:scale-95 ${
