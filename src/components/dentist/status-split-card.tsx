...
export default function StatusSplitCard({
 ...
 <h3 className="text-base font-semibold text-foreground">Status Split</h3>
 ...
 <div className="mt-8 space-y-3 text-[11px] font-semibold uppercase tracking-wider text-muted-foreground/80">
 ...
 <div className="flex items-center justify-between">
 <p className="flex items-center gap-2">
 <span className="h-2.5 w-2.5 rounded-full bg-indigo-600 shadow-sm shadow-indigo-600/20" /> Completed
 </p>
