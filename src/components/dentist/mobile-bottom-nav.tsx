    ...
    <nav className="fixed inset-x-0 bottom-0 z-40 border-t border-black/10 bg-white lg:hidden">
      <div className="mx-auto grid h-16 max-w-md grid-cols-4 px-2">
        ...
        >
          <span
            className={`flex h-7 w-7 items-center justify-center rounded-xl ${
              active === "dashboard" ? "bg-[#432DD7]/10 text-[#432DD7]" : "text-slate-500"
            }`}
          >
          ...
          <span
            className={`text-[10px] font-medium ${
              active === "dashboard" ? "text-[#432DD7]" : "text-slate-500"
            }`}
          >
            Dashboard
          </span>
        ...
        >
          <span
            className={`flex h-7 w-7 items-center justify-center rounded-xl ${
              active === "bookings" ? "bg-[#432DD7]/10 text-[#432DD7]" : "text-slate-500"
            }`}
          >
          ...
          <span
            className={`text-[10px] font-medium ${
              active === "bookings" ? "text-[#432DD7]" : "text-slate-500"
            }`}
          >
            Bookings
          </span>
        ...
        >
          <span
            className={`flex h-7 w-7 items-center justify-center rounded-xl ${
              active === "calendar" ? "bg-[#432DD7]/10 text-[#432DD7]" : "text-slate-500"
            }`}
          >
          ...
          <span
            className={`text-[10px] font-medium ${
              active === "calendar" ? "text-[#432DD7]" : "text-slate-500"
            }`}
          >
            Calendar
          </span>
        ...
        >
          <span
            className={`flex h-7 w-7 items-center justify-center rounded-xl ${
              active === "services" ? "bg-[#432DD7]/10 text-[#432DD7]" : "text-slate-500"
            }`}
          >
          ...
          <span
            className={`text-[10px] font-medium ${
              active === "services" ? "text-[#432DD7]" : "text-slate-500"
            }`}
          >
            Services
          </span>
