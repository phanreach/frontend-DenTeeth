  ...
  return (
    <article
      ...
      className={`group relative cursor-pointer overflow-hidden rounded-2xl border bg-card p-4 transition hover:shadow-lg ${
        isPending
          ? "border-indigo-600/20 shadow-indigo-600/5 dark:border-indigo-500/30"
    ...
    >
      ...
      <div className="mt-4 rounded-xl bg-muted/50 p-3 ring-1 ring-border">
        <p className="text-xs font-semibold text-indigo-600 dark:text-indigo-400">{item.service}</p>
      ...
      {isPending ? (
        <div className="mt-4 flex gap-2">
          <button
            ...
            className="flex-1 h-9 cursor-pointer rounded-xl bg-indigo-600 text-xs font-bold text-white transition hover:bg-indigo-700 active:scale-95 dark:bg-indigo-500 dark:hover:bg-indigo-400"
          >
            Confirm
          </button>
          <button
            ...
            className="h-9 w-20 cursor-pointer rounded-xl bg-rose-50 text-xs font-bold text-rose-600 transition hover:bg-rose-100 active:scale-95 dark:bg-rose-950/20 dark:text-rose-400 dark:hover:bg-rose-950/40"
          >
            Reject
          </button>
          <button
        ...
        <div className="mt-4 flex items-center justify-between border-t border-border pt-3">
          ...
          <button className="text-[11px] font-bold text-indigo-600 hover:underline dark:text-indigo-400">
            View Details
          </button>
        </div>
      )}
