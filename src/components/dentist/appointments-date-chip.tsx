...
export default function AppointmentsDateChip({ item }: { item: DateChipData }) {
 ...
 <p className="text-sm font-semibold text-slate-500">All</p>
 ...
 item.active ? "border-indigo-600 bg-indigo-600" : "border-black/10 bg-white"
 }`}
 >
 ...
 <p className={`text-base font-semibold ${item.active ? "text-white" : "text-neutral-900"}`}>{item.dayNumber}</p>
