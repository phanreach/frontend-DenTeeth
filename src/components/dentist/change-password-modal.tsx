...
export default function ChangePasswordModal({
 ...
 className="h-11 cursor-pointer rounded-2xl bg-indigo-600 text-sm font-semibold text-white transition enabled:hover:bg-indigo-600 disabled:opacity-40"
 >
...
const PasswordField = forwardRef<HTMLInputElement, PasswordFieldProps>(
 ...
 className={`h-11 w-full rounded-xl border bg-slate-50 px-4 pr-11 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-indigo-600 focus:ring-1 focus:ring-indigo-600 ${
